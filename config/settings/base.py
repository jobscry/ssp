...
DATABASES = {
    ...
    "default": env.db("DATABASE_URL", default="postgres:///ssp",)
}
...
MIGRATION_MODULES = {"sites": "ssp.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ssp.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("Joe Vasquez", "joe-vasquez@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "ssp.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "ssp.users.adapters.SocialAccountAdapter"
